...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _SettingLoader() {
    ...
    if (UserSettings.bannerGradient != null && 
        UserSettings.bannerGradient.colors.length >= 2) {
    ...
    sliderValue = UserSettings.paramter ?? 0.0;
  }
  ...
  void _updateGradient() {
    if (selectedBlendMode == 'linear') {
      ...
      selectedGradient = SweepGradient(
        colors: [selectedColor1, selectedColor2],
        startAngle: 0,
        endAngle: (4 * (math.pi+1) * (sliderValue/2.0 + 0.5)).clamp(0.000000000001, (4*math.pi + 1)),
      );
    }
  }
          ...
          children: [
            ...
            Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: availableImages.entries
                      .map(
                        (item) => InkWell(
                          onTap: () {
                            setState(() {
                              selectedImagePath = item.value;
                              UserSettings.userImagePath = item.value;
                            });
                          },
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border.all(
                                color: item.value == selectedImagePath
                                    ? AppConstants.accentColor1
                                    : AppConstants.textColor,
                                width: item.value == selectedImagePath
                                    ? 4.0
                                    : 2.0,
                              ),
                              borderRadius: BorderRadius.circular(
                            ...
                            child: ClipRRect(
                              ...
                              child: item.key == 'UserImage'
                                  ? Image.network(
                                      item.value,
                                      width:
                                          AppConstants.iconSizeLarge(context) *
                                          (item.value == selectedImagePath
                                              ? 1.1
                                              : 1.0),
                                      height:
                                          AppConstants.iconSizeLarge(context) *
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: AppConstants.mainContainerWidth(context) * 0.05),
                      Container(
                        height: AppConstants.mainContainerHeight(context) * 0.05,
                        width: AppConstants.mainContainerWidth(context) * 0.25,
                        child: ElevatedButton(
