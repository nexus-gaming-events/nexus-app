                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Stack(
                                  ...
                                  children: [
                                    SizedBox(
                                      height:
                                          AppConstants.playerBoxHeight(
                                            context,
                                          ) -
                                          AppConstants.sectionHeaderHeight(
                                            context,
                                          ),
                                      width: AppConstants.playerBoxWidth(
                                        context,
                                      ),
                                      child: SingleChildScrollView(
                                        padding: EdgeInsets.all(
                                    ...
                                    Positioned(
                                      ...
                                      child:
                                          ...
                                          : Container(
                                              ...
                                              height:
                                                  AppConstants.joinButtonHeight(
                                                    context,
                                                  ),
                                              width:
                                                  AppConstants.joinButtonWidth(
                                                    context,
                                                  ),
                                              decoration: BoxDecoration(
                                                color:
                                              ...
                                              child: Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    if (isUserInPlayers) {
                                                      debugPrint(
                                                        'Player button tapped: User is currently a player, attempting to leave event',
                                                      );
                                                      await DataManager.leaveEvent(
                                                        widget.event!.id,
                                                      );
                                                      debugPrint(
                                                        'Left event as player, updating state',
                                                      );
                                                      setState(() {
                          ...
                          SizedBox(
                            width: AppConstants.paddingLarge(context) * 0.2,
                          ),
                          Container(
                            width: AppConstants.playerBoxWidth(context),
                            height: AppConstants.playerBoxHeight(context),
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  alignment: Alignment.topLeft,
                                  width:
                                      AppConstants.descriptionWidth(context) *
                                      0.5,
                                  height: AppConstants.sectionHeaderHeight(
                                    context,
                                  ),
